...
<%
	...
	try {
        ...
        String uu = (String)session.getAttribute("username");
            ...
            %>
            <input class="button" type="button" value="Add Criteria" onclick="onc()" required>
            <input class="button" type="button" value="More Options" onclick="onc2()" required><br>
        <%
